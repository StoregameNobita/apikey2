...
var creatorList = ['@ffnobita','@ffnobita007','@nobita_ajalah','@nobitaanjay', '@nobitaganssss','@nobitaganteng','@nobitagantengg'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'nobitaganz') return res.json(loghandler.invalidKey)
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'nobitagans') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'nobitagans') return res.json(loghandler.invalidKey)
...
router.get('/base', async (req, res, next) => {
	var type = req.query.type,
		...
		if (!apikeyInput) return res.json(loghandler.notparam)
		if (apikeyInput != 'nobitaganz') return res.json(loghandler.invalidKey)
